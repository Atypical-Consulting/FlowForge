 ...
 */
export const COMMIT_TYPE_THEME: Record<
...
> = {
  ...
  chore: {
    ...
    badgeClasses: "text-ctp-lavender bg-ctp-lavender/10 border-ctp-lavender/30",
    emoji: "\u{2699}\u{FE0F}",
    label: "Chore",
  },
  ci: {
...
export function getCommitTypeIcon(type: ConventionalCommitType): ElementType {
