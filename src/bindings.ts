...
export const commands = {
  ...
  async openRepository(path: string): Promise<Result<RepoStatus, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("open_repository", { path }),
      };
    } catch (e) {
  ...
  async getRepositoryStatus(): Promise<Result<RepoStatus, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_repository_status"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async isGitRepository(path: string): Promise<Result<boolean, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("is_git_repository", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async unstageFile(path: string): Promise<Result<null, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("unstage_file", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async stageFiles(paths: string[]): Promise<Result<null, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("stage_files", { paths }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async unstageFiles(paths: string[]): Promise<Result<null, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("unstage_files", { paths }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getFileDiff(
    ...
    staged: boolean,
    contextLines: number,
  ): Promise<Result<FileDiff, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_file_diff", {
          path,
          staged,
          contextLines,
        }),
  ...
  async getCommitFileDiff(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_commit_file_diff", {
          oid,
          path,
          contextLines,
        }),
  ...
  async getFileBase64(filePath: string): Promise<Result<string, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_file_base64", { filePath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCommitFileBase64(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_commit_file_base64", { oid, filePath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async getFileDiffHunks(
    path: string,
    staged: boolean,
  ): Promise<Result<DiffHunkDetail[], GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_file_diff_hunks", { path, staged }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async stageHunks(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("stage_hunks", { path, hunkIndices }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async unstageHunks(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("unstage_hunks", { path, hunkIndices }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async stageLines(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("stage_lines", {
          path,
          hunkIndex,
          lineRanges,
        }),
  ...
  async unstageLines(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("unstage_lines", {
          path,
          hunkIndex,
          lineRanges,
        }),
  ...
  async createCommit(
    message: string,
    amend: boolean,
  ): Promise<Result<CommitInfo, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_commit", { message, amend }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCommitHistory(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_commit_history", { skip, limit }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCommitDetails(
    oid: string,
  ): Promise<Result<CommitDetails, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_commit_details", { oid }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCommitGraph(
    limit: number | null,
    offset: number | null,
  ): Promise<Result<CommitGraph, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_commit_graph", { limit, offset }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async fetchFromRemote(
    remote: string,
    onProgress: TAURI_CHANNEL<SyncProgress>,
  ): Promise<Result<SyncResult, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("fetch_from_remote", { remote, onProgress }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async pushToRemote(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("push_to_remote", { remote, onProgress }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async pullFromRemote(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("pull_from_remote", { remote, onProgress }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async createBranch(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_branch", { name, checkout }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async checkoutBranch(branchName: string): Promise<Result<null, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("checkout_branch", { branchName }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteBranch(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("delete_branch", { branchName, force }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async batchDeleteBranches(
    branchNames: string[],
    force: boolean,
  ): Promise<Result<BatchDeleteResult, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("batch_delete_branches", {
          branchNames,
          force,
        }),
      };
  ...
  async getRecentCheckouts(
    limit: number | null,
  ): Promise<Result<RecentCheckout[], GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_recent_checkouts", { limit }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getBranchAheadBehind(
    branchName: string,
  ): Promise<Result<AheadBehind, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_branch_ahead_behind", { branchName }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async stashSave(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("stash_save", { message, includeUntracked }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async stashApply(index: number): Promise<Result<null, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("stash_apply", { index }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async stashDrop(index: number): Promise<Result<null, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("stash_drop", { index }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<TagInfo, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_tag", { name, message, targetOid }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async mergeBranch(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("merge_branch", { sourceBranch }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getConflictContent(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_conflict_content", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async resolveConflictFile(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("resolve_conflict_file", { path, content }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async startFeature(name: string): Promise<Result<string, GitflowError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("start_feature", { name }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async startRelease(version: string): Promise<Result<string, GitflowError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("start_release", { version }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<string, GitflowError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("finish_release", { tagMessage }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async startHotfix(name: string): Promise<Result<string, GitflowError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("start_hotfix", { name }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async finishHotfix(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("finish_hotfix", { tagMessage }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<WorktreeInfo, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_worktree", { options }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<InitResult, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("git_init", { path, defaultBranch }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async listGitignoreTemplates(): Promise<
    Result<GitignoreTemplateList, GitError>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("list_gitignore_templates"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async getGitignoreTemplate(
    name: string,
  ): Promise<Result<GitignoreTemplate, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_gitignore_template", { name }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async detectProjectType(
    path: string,
  ): Promise<Result<ProjectDetection, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("detect_project_type", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async writeInitFiles(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("write_init_files", { path, files }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async fetchNugetInfo(
    packageId: string,
  ): Promise<Result<NugetPackageInfo, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("fetch_nuget_info", { packageId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listRepoFiles(
    path: string,
  ): Promise<Result<RepoFileEntry[], GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("list_repo_files", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async readRepoFile(
    filePath: string,
  ): Promise<Result<RepoFileContent, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("read_repo_file", { filePath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getRepoInsights(days: number): Promise<Result<RepoInsights, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_repo_insights", { days }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getBranchHealth(
    staleDays: number,
  ): Promise<Result<BranchHealthInfo[], GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_branch_health", { staleDays }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getGitGlobalConfig(): Promise<Result<GitGlobalConfig, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_git_global_config"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setGitGlobalConfig(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_git_global_config", { key, value }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<ExtensionManifest[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("discover_extensions", { extensionsDir }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async extensionFetchManifest(
    gitUrl: string,
  ): Promise<Result<ExtensionFetchResult, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("extension_fetch_manifest", { gitUrl }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async extensionInstall(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("extension_install", {
          tempPath,
          extensionsDir,
        }),
      };
  ...
  async extensionUninstall(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("extension_uninstall", {
          extensionId,
          extensionsDir,
        }),
      };
   ...
   */
  async extensionCancelInstall(
    tempPath: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("extension_cancel_install", { tempPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async githubDetectRemotes(): Promise<
    Result<GitHubRemoteInfo[], GitHubError>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("github_detect_remotes"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   * "closed", or "all".
   */
  async githubListPullRequests(
    owner: string,
    repo: string,
    state: string,
    page: number,
    perPage: number,
  ): Promise<Result<PullRequestListResponse, GitHubError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("github_list_pull_requests", {
          owner,
          repo,
          state,
          page,
  ...
  async githubGetPullRequest(
    ...
    repo: string,
    number: number,
  ): Promise<Result<PullRequestDetail, GitHubError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("github_get_pull_request", {
          owner,
          repo,
          number,
        }),
  ...
  async githubListIssues(
    ...
    page: number,
    perPage: number,
  ): Promise<Result<IssueListResponse, GitHubError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("github_list_issues", {
          owner,
          repo,
          state,
          page,
   ...
   */
  async githubGetIssue(
    owner: string,
    repo: string,
    number: number,
  ): Promise<Result<IssueDetail, GitHubError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("github_get_issue", { owner, repo, number }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async githubMergePullRequest(
    ...
    sha: string | null,
  ): Promise<Result<MergePullRequestResult, GitHubError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("github_merge_pull_request", {
          owner,
          repo,
          pullNumber,
          mergeMethod,
  ...
  async githubCreatePullRequest(
    ...
    body: string | null,
    draft: boolean | null,
  ): Promise<Result<CreatePullRequestResult, GitHubError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("github_create_pull_request", {
          owner,
          repo,
          title,
          head,
   ...
   */
  async githubGetBranchInfoForPr(): Promise<
    Result<BranchInfoForPr, GitHubError>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("github_get_branch_info_for_pr"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async getRepoHealthQuick(
    path: string,
  ): Promise<Result<RepoHealth, GitError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_repo_health_quick", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async openInTerminal(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("open_in_terminal", { path, terminal }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type GitError =
  ...
  | { type: "SignatureError"; message: string }
  | { type: "RemoteNotFound"; message: string }
  | { type: "AuthenticationFailed"; message: string }
  | { type: "PushRejected"; message: string }
  | { type: "NetworkError"; message: string }
  | { type: "BranchNotFound"; message: string }
  | { type: "CannotDeleteCurrentBranch" }
  | { type: "BranchNotMerged"; message: string }
  | { type: "InvalidBranchName"; message: string }
  | { type: "BranchAlreadyExists"; message: string }
  | { type: "DirtyWorkingDirectory" }
  | { type: "StashNotFound"; message: number }
  | { type: "NothingToStash" }
  | { type: "TagAlreadyExists"; message: string }
  | { type: "TagNotFound"; message: string }
  | { type: "NoMergeInProgress" }
  | { type: "FileNotConflicted"; message: string }
  ...
  | { type: "HunkIndexOutOfRange"; message: number }
  | { type: "LineRangeInvalid"; message: string }
...
export type SyncProgress =
  | { event: "started"; data: { operation: string } }
  | { event: "counting"; data: { current: number; total: number } }
  | { event: "compressing"; data: { current: number; total: number } }
  | {
      event: "transferring";
      data: { current: number; total: number; bytes: number };
    }
  | { event: "resolving"; data: { current: number; total: number } }
  | { event: "finished"; data: { operation: string } }
